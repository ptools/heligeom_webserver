            ...
            if pdb_filename:
                ...
                try:
                    ...
                    return render_template(
                        "run.html", form=form, screw_data=screw_data, screw_data_bis=data_bis
                    )
                except Exception as e:
                    return render_template(
                        "error.html", summary=str(e), error_log=traceback.format_exc()
                    )
        ...
        # Construction requested
            ...
            if pdb_filename:
                ...
                user_inputs = UserInputs(
                    ...
                    n_mer=form.n_mer.data,
                    z_align=form.z_align.data,
                )
...
def results(results_id):
    ...
    try:
        ...
        if not query_result.second_oligomer:
            ...
            print(z_align)
            # Run the Heligeom calculations and write the PDB result in pdb_out_abs_path
            hp2, pitch2, nb_monomers2, direction2, dminbis, dmaxbis = construct(
                pdb_abs_path2,
                chain1bis_id,
                chain2bis_id,
                res_range1bis,
